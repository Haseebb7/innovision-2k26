...
const BottomNav = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass-panel-heavy border-t border-cyber-border rounded-t-2xl safe-pb shadow-[0_-8px_30px_rgba(168,85,247,0.06)]">
